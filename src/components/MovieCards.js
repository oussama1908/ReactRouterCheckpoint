...
import '../App.css'; // Make sure to adjust the import path for your CSS styles
import CustomStarRating from '../components/StarRating'; // Import your custom star rating component
        ...
        <div className='cardtext'>
          ...
          <div className='cardtexto'>
            {isEditing ? (
              ...
              <CustomStarRating initialValue={rating} />
            )}
          </div>
        </div>
        <br/>
